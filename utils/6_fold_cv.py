...
if __name__ == '__main__':
    ...
    for file_name in data_path:
        ...
        points = np.vstack((original_data['x'], original_data['y'], original_data['z']*-1)).T
        ...
        print('seen {}'.format(test_total_seen))
        print('correct {}'.format(test_total_correct))
        ...
        print('true {}'.format(true_positive_classes))
    ...
    print('complete eval accuracy: {}'.format(test_total_correct / float(test_total_seen)))
